namespace WORDLE_PART_3
{
    public partial class WORDLE : Form
    {
        ...
        public void checkWord(RichTextBox richTextBox1, RichTextBox richTextBox2, RichTextBox richTextBox7)
        {
            richTextBox2.Visible = true;

            richTextBox1.ReadOnly = true;
            char[] o = word.ToCharArray();
            char[] t = richTextBox1.Text.ToCharArray();
            if (word == richTextBox1.Text)
            {
            ...
            {
                if (o[i] != t[i] && word.Contains(t[i]))
                {
                    richTextBox1.Select(i, 1);
                    richTextBox1.SelectionColor = Color.Yellow;
                    richTextBox1.DeselectAll();
                    int ind = richTextBox7.Text.ToLower().IndexOf(t[i]);
                    richTextBox7.Select(ind, 1);
                    richTextBox7.SelectionColor = Color.Yellow;

                }
                else if (o[i] != t[i] && !word.Contains(t[i]))
                {
                    richTextBox1.Select(i, 1);
                ...
                else if (o[i] == t[i])
                {
                    ...
                    int ind = richTextBox7.Text.ToLower().IndexOf(t[i]);
                    richTextBox7.Select(ind, 1);
                    richTextBox7.SelectionColor = Color.Green;

                }
            }
        }
        public void checkWordLast(RichTextBox richTextBox6, RichTextBox richTextBox7)
        {
            
                
                richTextBox6.ReadOnly = true;
                char[] o = word.ToCharArray();
                char[] t = richTextBox6.Text.ToCharArray();
                if (word == richTextBox6.Text)
                {
                ...
                for (int i = 0; i < o.Length; i++)
                {
                    if (o[i] != t[i] && word.Contains(t[i]))
                    {
                        richTextBox6.Select(i, 1);
                        richTextBox6.SelectionColor = Color.Yellow;
                    int ind = richTextBox7.Text.ToLower().IndexOf(t[i]);
                    richTextBox7.Select(ind, 1);
                    richTextBox7.SelectionColor = Color.Yellow;
                }
        ...
        private void richTextBox1_KeyDown(object sender, KeyEventArgs e)
        {
            if(e.KeyCode == Keys.Enter)
            {
                ...
                {
                    checkWord(richTextBox1, richTextBox2, richTextBox7);
                }
        ...
        private void richTextBox2_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    checkWord(richTextBox2, richTextBox3, richTextBox7);
        ...
        private void richTextBox3_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    checkWord(richTextBox3, richTextBox4, richTextBox7);
        ...
        private void richTextBox4_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    checkWord(richTextBox4, richTextBox5, richTextBox7);
        ...
        private void richTextBox5_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    checkWord(richTextBox5, richTextBox6, richTextBox7);
        ...
        private void richTextBox6_KeyDown(object sender, KeyEventArgs e)
        {
            if (e.KeyCode == Keys.Enter)
            {
                ...
                {
                    checkWordLast(richTextBox6, richTextBox7);
